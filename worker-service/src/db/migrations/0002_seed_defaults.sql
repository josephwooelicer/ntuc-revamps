...
INSERT OR IGNORE INTO data_source (
  ...
  ('src-singstat', 'SingStat', 'gov', 'api', 'macro_labor', 0.95, 1),
  ('src-mom', 'MOM', 'gov', 'api', 'macro_labor', 0.95, 1),
  ('src-ura', 'URA Rental Index', 'gov', 'api', 'industry_cost_pressure', 0.95, 1),
  ('src-acra', 'ACRA', 'gov', 'api', 'registry_compliance', 0.90, 0),
  ('src-egazette', 'eGazette', 'gov', 'api', 'registry_compliance', 0.90, 1),
  ('src-news', 'News Aggregator', 'news', 'scrape', 'events_mentions', 0.75, 1),
  ('src-reddit-sg', 'Reddit Singapore', 'forum', 'api', 'public_sentiment', 0.55, 1),
  ('src-hardwarezone', 'HardwareZone', 'forum', 'scrape', 'public_sentiment', 0.50, 1);
